...
<li> The <a href="Generic-Internal-RateOfReturn-2007-2016-rev.02-16-2016a.xlsx">
<B>Generic-Internal-RateOfReturn-2007-2016-rev.02-16-2016a.xlsx</B></A>
...
<li> 
The <a href="Simple Asset Allocation calculator using Index Funds-2-15-2017.xlsx"> 
<B>Simple Asset Allocation calculator using Index Funds-2-15-2017.xlsx</B></A>
The spreadsheet helps compute the dollar amounts for a simple asset allocation using broad total market index funds or index-ETFs. Broad index funds include total U.S. stock market, total international stock market (no U.S. stocks), and Total bond market (U.S. only). One could also add municipal and international bonds/bond funds. Some instances of these funds are listed. Expected portfolio returns for a 3-fund portfolio are computed). An example is shown for using back-testing software to see how well your asset allocation might have done.<BR>
<B>VERSION:</B> 2-15-2017
<p>
</p></li></ol> 
