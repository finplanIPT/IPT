...
<B>IPT-Demo-V.0.24.17-09-16-2016a.xlsx</B></A><BR>
...
<B>Revision notes</B> for V.0.25.02-10-02-2016a. Fixed bad retirement age display link in 10.1 ExpensesData "S1/S2 yearly expenses after retire at age". Added optional alternate COLAs for S1 and S2 in the 10. ExpensesData 10.2.1 irregular expenses data entry table.  This lets you specify COLAs for expenses that you expect to have a much higher or lower COLAs than the default expense COLA specified in 10.1.2. If the alternate COLa value specifed is 0%, it defaults to the default expenses COLA. An example might be future college costs that may be on the order of 5%. Some COLAS may even be negative. Values of the S1 and S2 alternate COLAs  not zero are flagged with a green background.<BR>
